...
from .views import VideoListView, GenreVideoListView, VideoDetailView, VideoProgressView, VideoProgressDetailView, VideoProgressListView
...
urlpatterns = [
    ...
    path('video-progress/<int:video_id>/', VideoProgressDetailView.as_view(), name='video-progress-detail'),
    path('video-progress-list/', VideoProgressListView.as_view(), name='video-progress-list'),
]
